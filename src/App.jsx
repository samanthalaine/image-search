...
function App() {
  ...
  useEffect(() => {
    ...
    const fetchImages = async () => {
      const res = await fetch(`https://pixabay.com/api/?key=${import.meta.env.VITE_REACT_APP_PIXABAY_API_KEY}&q=${term}&image_type=photo&pretty=true&safesearch=true&per_page=21`)
